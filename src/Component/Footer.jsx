...
export default function Footer() {
  return (
    <section className=" bg-[#07132E] text-white  relative px-4">
      <div className="">
        <div className="  bg-red-200 flex justify-center items-center ">
          <div className="absolute bg-gray-200  w-[500px] md:w-[600px] py-6 p-4 rounded-lg flex flex-col md:flex-row justify-between items-center top-[-50px]">
